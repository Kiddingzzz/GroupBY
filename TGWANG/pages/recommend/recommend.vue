		...
		<view class="uni-list">
			<view class="uni-list-cell" hover-class="uni-list-cell-hover" v-for="(value,key) in listData" :key="key" @click="goDetail(value.id)">
				<view class="uni-media-list">
					<image class="uni-media-list-logo" :src="value.headerImg"></image>
					<view class="uni-media-list-body">
						<view class="uni-media-list-text-top">{{value.houseTitle}}</view>
						<view class="uni-media-list-text-bottom">
							<text>{{value.genereMange}}</text>
							<text>{{value.def}}</text>
						</view>
					</view>
				</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			async getNewsList() {
				const data = {
					MaxResultCount: this.maxR
				}
				var res = await this.$http.get('api/cms/new/newsList', data);
