...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    update: function update(state, config) {
      ...
      Object.keys(config).map(function (item, key) {
        state[item] = config[item];
      });
    },
    remove: function remove(state, props) {
...
var _common = _interopRequireDefault(__webpack_require__(/*! ./common */ 22));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};var ownKeys = Object.keys(source);if (typeof Object.getOwnPropertySymbols === 'function') {ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) {return Object.getOwnPropertyDescriptor(source, sym).enumerable;}));}ownKeys.forEach(function (key) {_defineProperty(target, key, source[key]);});}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}

var api_host = _config.default.API_HOST;

function _request(api, method, data) {var header = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
  // uni.showLoading({
  // 	title: '加载中' //数据请求前loading
  // });

  console.time('Ajax?' + api);
  var _logTimeEnd = function _logTimeEnd() {
    console.timeEnd('Ajax?' + api);
  };

  // 设置Token
  var token = _common.default.getAuthCode();
  ...
  var targetApi = api.indexOf('http') != -1 ? api : "".concat(api_host, "/").concat(api);
  return new Promise(function (resolve, reject) {
    uni.request({
      url: targetApi,
      data: data,
      ...
      fail: function fail(error) {
        console.error("HTTP-ERROR:".concat(JSON.stringify(error)));
        reject(error);
      },
...
var _get = function _get(api, data) {
  return _request(api, 'GET', data);
};
var _post = function _post(api, data) {
  return _request(api, 'POST', data);
};
var _del = function _del(api, data) {
  return _request(api, 'DELETE', data);
};
var _put = function _put(api, data) {
  return _request(api, 'PUT', data);
};

var _upload = function _upload(uploadFile) {var fileType = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'picture';var taskCallback = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
...

{
  ...
  get: _get,
  request: _request,
  upload: _upload };exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; // const host = 'http://192.168.0.10:9011'
var host = 'http://localhost:57992';var _default =
{
  API_HOST: host };exports.default = _default;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var KEY_ACCESS_TOKEN = 'ACCESS_TOKEN';
...
}var _default =
{
  ...
  getInfoFromExtra: function getInfoFromExtra(key, extra) {
    if (extra && extra.length > 0) {
      var list = extra;
      var item = list.find(function (d) {return d.name == key;});
  ...
  navigateToBack: function navigateToBack(delta) {
    uni.navigateBack({
      delta: delta || 1 });

  },
  getValueOrDefault: function getValueOrDefault(value, defaultVal) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/center/center": { "navigationBarTitleText": "我的" }, "pages/home/home": { "navigationBarTitleText": "首页" }, "pages/home/Img/ImgCenter": { "navigationBarTitleText": "图片详情" }, "pages/recommend/recommend": { "navigationBarTitleText": "推荐" }, "pages/home/detail": { "navigationBarTitleText": "详情" }, "pages/home/loupanParameters": { "navigationBarTitleText": "楼盘参数" } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "uni-app", "navigationBarBackgroundColor": "#F8F8F8", "backgroundColor": "#F8F8F8" } };exports.default = _default;
